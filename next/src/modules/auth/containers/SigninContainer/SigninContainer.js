...
import { combine, condition, required, minLength, email, equalsField, allowedStandardCharacters } from 'app/lib/form/validation'
...
const validations = {
  name: combine([required, allowedStandardCharacters]),
  email: combine([required, email]),
  password: combine([required, allowedStandardCharacters, minLength(6)]),
